...
void fill_gaps_bs_OOOOLLLLDDDD(mapping_batch_t *mapping_batch, sw_optarg_t *sw_optarg, 
...
void fill_gaps_bs(mapping_batch_t *mapping_batch, sw_optarg_t *sw_optarg, 
  ...
  //fq_batch1 = mapping_batch->fq_batch;
  //fq_batch2 = mapping_batch->fq_batch;
  ...
  if (sw_prepare_list1) array_list_free(sw_prepare_list1, (void *) NULL);
  sw_multi_output_free(output2);
  if (sw_prepare_list2) array_list_free(sw_prepare_list2, (void *) NULL);
}
